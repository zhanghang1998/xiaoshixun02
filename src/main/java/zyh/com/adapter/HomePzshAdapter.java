...
public class HomePzshAdapter extends RecyclerView.Adapter<HomePzshAdapter.MyHoadler> {

    private Context context;
    private List<CommodityListBean> list = new ArrayList<>();

    public HomePzshAdapter(Context context) {
        this.context = context;
    }

    @NonNull
    @Override
    public HomePzshAdapter.MyHoadler onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HomePzshAdapter.MyHoadler myHoadler, int i) {
