...
public class OrderFrag04Adapter extends RecyclerView.Adapter<OrderFrag04Adapter.MyLoadler> {

    private List<OrderListBean> list = new ArrayList<>();
    private Context context;

    public OrderFrag04Adapter(Context context) {
        this.context = context;
    }

    @NonNull
    @Override
    public OrderFrag04Adapter.MyLoadler onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.frag04_orderfrag04_rlist_item, viewGroup, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull OrderFrag04Adapter.MyLoadler myLoadler, int i) {
