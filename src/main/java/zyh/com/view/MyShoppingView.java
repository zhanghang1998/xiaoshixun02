...
public class MyShoppingView extends LinearLayout implements View.OnClickListener {

    private TextView mAddBtn,mSubBtn;
    private TextView mNumText;
    private AddSubListener addSubListener;

    public MyShoppingView(Context context) {
        super(context);
        initView();
    }

    public MyShoppingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public MyShoppingView(Context context,AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(){
        ...
        View view = View.inflate(getContext(),R.layout.frag03_shop_item_view,this);
